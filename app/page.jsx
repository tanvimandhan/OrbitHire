             ...
             return (
              ...
              <CardContent className="pt-6 ">
                <div className="flex flex-col space-y-4">
                  ...
                  <blockquote>
                    <p className="text-muted-forground italic relative">
                      <span className="text-3xl text-primary absolute -top-4 -left-2">&quot;</span>{testimonial.quote}
                      <span className="text-3xl text-rpimary absolute -bottom-4">&quot;</span>
                    </p>
                  </blockquote>
                </div>
              </CardContent>
